...
def create_arg_parser():
    ...
    parser.add_argument('--num-iters-discriminator', type=int, default=5, help='Number of iterations of the discriminator')
    parser.add_argument('--latent-size', type=int, default=0, help='Size of latent vector for z location 2')
