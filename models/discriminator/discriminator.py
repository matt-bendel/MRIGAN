...
class DiscriminatorModel(nn.Module):
    def __init__(self, in_chans, out_chans, z_location, model_type):
        ...
        self.initial_layers = nn.Sequential(
            nn.Conv2d(self.in_chans, 4, kernel_size=(3, 3), padding=1),  # 384x384
            nn.InstanceNorm2d(4),
            nn.LeakyReLU()
        ...
        self.encoder_layers += [FullDownBlock(4, 8)]  # 48x48
        self.encoder_layers += [FullDownBlock(8, 16)]  # 24x24
        self.encoder_layers += [FullDownBlock(16, 32)]  # 12x12
        self.encoder_layers += [FullDownBlock(32, 64)]  # 6x6
        self.encoder_layers += [FullDownBlock(64, 128)]  # 3x3
