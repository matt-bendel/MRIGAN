...
class UnetModel(nn.Module):
    ...
    def __init__(self, in_chans, out_chans, chans, num_pool_layers, z_location, drop_prob, model_type):
        """
        Args:
    ...
    def forward(self, input, z=None):
        ...
        return (self.conv2(output) + input) if self.model_type == 'kspace' else self.conv2(output)
