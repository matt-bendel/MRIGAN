...
class FJDMetric:
    ...
    def _get_generated_distribution(self, cfid=False):
        ...
        torch.save(image_embed, 'image_embeds.pt')
        torch.save(cond_embed, 'cond_embeds.pt')
        torch.save(true_embed, 'true_embeds.pt')
    ...
    def get_cfid_torch(self, resample=True):
        ...
        return m_dist + c_dist1 + c_dist2, c_y_true_x_true.cpu().numpy()
    ...
    def get_cfid(self, resample=True):
        ...
        return m_dist + c_dist1 + c_dist2, c_y_true_x_true.numpy()
